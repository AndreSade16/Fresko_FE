...
function ListSection({ activeShoppingList, isLoading }: ListSectionProps) {
  const navigate = useNavigate();

  return (
    <Card
      className="border-0 rounded-4 overflow-hidden shadow-lg position-relative my-5 mx-lg-4"
